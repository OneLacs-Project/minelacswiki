...
`Real Money Trading` `RMT` `Торговля Рельной Валютой` - Торговля предметами, услугами, и тд. в игровой среде при использовании реальных денежных средств.

`Stream sniping` `Стрим-снайпинг` - Использование прямой трансляции для определения текущего места нахождения стримера и последущее пребывание возле/в поле зрения стримера без приглашения. 
