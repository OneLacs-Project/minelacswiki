...
<Links :items="[
    { 
        name: 'Карта Сервера', 
        link: 'ml-world/server-map', 
        icon: 'solar:map-bold-duotone',
        color: '#868dcc'
    },
    { 
        name: 'Доп Механики', 
        link: 'ml-world/additional-mechanics', 
        icon: 'solar:cpu-bold-duotone', 
        color: '#868dcc' 
    },
    // { 
    //     name: 'FlectonePulse', 
    //     link: 'ml-world/flectone-pulse', 
    //     icon: 'solar:chat-round-dots-bold-duotone',
    //     color: '#868dcc'
    // },
    // { 
    //     name: 'Загрузка Ресурспаков', 
    //     link: 'ml-world/resourcepack-load',
    //     icon: 'solar:pallete-2-bold-duotone', 
    //     color: '#868dcc' 
    // },
    // {
    //     name: 'Пластинки',
    //     link: 'ml-world/music-discs',
...
`2 Апреля` -  **<span style="color: red;">Сезон завершен</span>**
...
<Links :items="[
    { name: 'ML Plus', icon: 'fas fa-archive', link: '../archive/ml-plus', icon: 'solar:archive-bold-duotone', color: '#868dcc'}
]"/>



## Участники
**<span style="color: gray;">Общее количество:</span> `43`** 
<span style="color: gray;"> (`38` + `5` [<iconify-icon icon="solar:user-block-bold-duotone"  style="margin:center;color: #FF0000"></iconify-icon>](#banned))</span><br/>**
...
- phonexr_ <img src="https://api.mineatar.io/face/0105365a-acc2-4e10-b4e0-7bd88f0c642a?scale=3" style="display: inline; margin: 0 2px; vertical-align: middle;" />
