...
|Деревянный|Железный|
|-|-|
|![](/WIKI/ML-Legends/ParCool/wooden_hook.png)|![](/WIKI/ML-Legends/ParCool/iron_hook.png)|

### Зиплайн <br/> <span style="color: gray;"><sup>(Всех 16 цветов)</sup></span>
|Крафт|Предназначение|
|-|-|
|![](/WIKI/ML-Legends/ParCool/zipline_rope.png)|- Вешается между двумя крюками. <br/> - Под наклоном -> Игрок спустится. <br/>- Ровно -> Можно передвигаться вдоль. <br/> - Не может быть вертикально.|
## Механики
...
![Работа стамины](/WIKI/ML-Legends/ParCool/stamina_preview.gif)
